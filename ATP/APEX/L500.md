...
We could provide him/her with some default charts prebuilt in APEX, however that would not allow the end user
to create entirely new analysis.
...
- In the main cloud console, click on the menu icon on the left.
  ...
  ![](./images/lab500/create_oac0.png)

- Then navigate to Platform Service => Analytics.

  ![](./images/lab500/create_oac1.png)
...
- Open APEX. If you have don't have the direct link, go to the Service Console of the database, then Development, then APEX.
  ...
  - On the top level of the page (named "Page 7: Customer Form"), add the HTML that you found in Developer - Embed - Embedding Script To Include. The URL will be specific for your environment.
...
- This is a simplified example, and it can be extended by adding SSO and/or data visibility that are required for each case. 
